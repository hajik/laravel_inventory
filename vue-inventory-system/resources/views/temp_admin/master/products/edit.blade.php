    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('sizes.update', $size->id) }}" class="form-horizontal form-label-left">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="name" id="name" value="{{ $size->name }}"  placeholder="Enter size" required="required" 
